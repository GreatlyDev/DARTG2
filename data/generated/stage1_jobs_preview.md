# Stage 1 Jobs Preview

Total anchors: 40
Total prompt jobs: 120

These are prompt jobs, not generated dialect responses yet. Each section shows the original anchor response first, then the three candidate-generation jobs prepared for that anchor-dialect pair.
...
- `A1_Southern_American_English_1` (candidate prompt 1)
- `A1_Southern_American_English_2` (candidate prompt 2)
- `A1_Southern_American_English_3` (candidate prompt 3)

## Anchor A2
- Assigned dialect: Midwestern/North Central
- Score band: low
...
Prepared candidate-generation jobs:
- `A3_Northeastern/New_England_1` (candidate prompt 1)
- `A3_Northeastern/New_England_2` (candidate prompt 2)
- `A3_Northeastern/New_England_3` (candidate prompt 3)

## Anchor A4
- Assigned dialect: Western American English
- Score band: low
...
```text
In the essay Do Not Exceed posted Speed Limit the setting affected the cyclist sense of direction. The cyclist knew where he was going and how to get there but the old men told him their short-cut. It ruined his own sense of direction because he was taking out-dated directions from old-timers that hadnt left their porches since Carter was in office. That is how the setting affected the cyclist in the's essay.
```

Prepared candidate-generation jobs:
- `A4_Western_American_English_1` (candidate prompt 1)
- `A4_Western_American_English_2` (candidate prompt 2)
- `A4_Western_American_English_3` (candidate prompt 3)

## Anchor A5
- Assigned dialect: Appalachian English
- Score band: low
- Normalized score: 1.8
...
```text
How the features of the setting affected the cyclist. The feature was that you should never take advice from old people that never get out of the house. For example in the story it says, Never accept travel advice from collection of old. times who havent left confines of their porches since carter was in office. This affecting the setting because if it werent for his map and let them take a peek at it, That would of saved him a load of trouble.
```

Prepared candidate-generation jobs:
- `A8_Midwestern/North_Central_1` (candidate prompt 1)
- `A8_Midwestern/North_Central_2` (candidate prompt 2)
- `A8_Midwestern/North_Central_3` (candidate prompt 3)
...
Prepared candidate-generation jobs:
- `A9_Northeastern/New_England_1` (candidate prompt 1)
- `A9_Northeastern/New_England_2` (candidate prompt 2)
- `A9_Northeastern/New_England_3` (candidate prompt 3)
...
```text
I think that @CAPS4 is fine if you take them out. Your should be @NUM1 or older to take them out of the libraries or stores if they are really that bad. If they are that bad they should have something on them like movies that are rated @CAPS1. I have read some books that are really good,but kids shouldn't read them. I read this book @CAPS3 'A @CAPS2 @CAPS3 @CAPS4' and @CAPS4 is really sad. @CAPS4's about this @CAPS2 and he tells us what his mom makes him do when he was little. I liked the book but @CAPS4 was sad,but I read @CAPS4 because people were talking about @CAPS4. Some parents won't let their children watch certain things on the t.v. because they think that they are bad. I was watching this t.v.
```

Prepared candidate-generation jobs:
- `A11_Appalachian_English_1` (candidate prompt 1)
- `A11_Appalachian_English_2` (candidate prompt 2)
...
```text
The books, magazines, music, and movies shouldn't be removed from the shelves. They still have good information that someone other than you @MONTH1 want to know. If you take them off of the shelves the people that want to use them don't have the opportunity. If you remove books then if someone needs one for a reseach paper that they have to do they will not have the nessisary resouces to do the paper, and at the same time the person with the paper @MONTH1 feel that the non-educational books need to come off the shelves and then that person wont have the books that they want. If they want the book taken off of the shelf, because of inopropriate language or nudity then the libraries can make a spot that you have to be a certain age to access them.
```
...
```text
The builders had a tough obstacle Because They in @CAPS1 were tryn to @CAPS2 A overall @CAPS3 Building. And were tryn to compete. The Dirigibles were A @CAPS3 part in Building The empire State Building Because They were faced with obstacles That were hard like @CAPS5, @CAPS6, Height and ext. These were the @CAPS7. On Dirigibles to @CAPS8 There were The Dirigibles were not heavy @CAPS9 They @CAPS10't @CAPS8 as well And It was made with light mater ials. These are The reasons why This happens.
```

Prepared candidate-generation jobs:
- `A13_Southern_American_English_1` (candidate prompt 1)
- `A13_Southern_American_English_2` (candidate prompt 2)
- `A13_Southern_American_English_3` (candidate prompt 3)
...
```text
The features in the setting affect cyclist in many ways. One of which is bring only to carry so much equipment which @MONTH1 be needed. For example, you can only take so much water with you and once you run out of there are no buildings or anything around that you are out of luck. Also, you can only take so much food. Finally, when you are ready to go to sleep you cant just pull over you have to ride until you find a hotel or get home. I know that I would not make it. So those are just a few reasons on why the setting affects cyclist.
```

Prepared candidate-generation jobs:
- `A14_Midwestern/North_Central_1` (candidate prompt 1)
- `A14_Midwestern/North_Central_2` (candidate prompt 2)
- `A14_Midwestern/North_Central_3` (candidate prompt 3)
...
```text
I think the mood in this story was sad/happy. I think it was happy because it says he loved to cook  And he thanked his parents for teaching him to cook. Also In paragraph @NUM1 Its a paragraph dedicated to his parents. I think it is sad because in paragraph @NUM2 it says his parents had very good Jobs but when they came to the united states they had to startover.
```

Prepared candidate-generation jobs:
- `A16_Western_American_English_1` (candidate prompt 1)
- `A16_Western_American_English_2` (candidate prompt 2)
- `A16_Western_American_English_3` (candidate prompt 3)
...
```text
I was patient when I went to the doctors. When I went to the doctors me and my mom wait patient for a long time. It felt like years but it was alone for @NUM1 hour then when the doctor called us back to the room wait for a long period of time and a nother half-hour we waited. I asked my mom why did it take forever my mom said because their other people befor us. oh I said ok then.
```

Prepared candidate-generation jobs:
- `A17_Appalachian_English_1` (candidate prompt 1)
- `A17_Appalachian_English_2` (candidate prompt 2)
...
Prepared candidate-generation jobs:
- `A21_Northeastern/New_England_1` (candidate prompt 1)
- `A21_Northeastern/New_England_2` (candidate prompt 2)
- `A21_Northeastern/New_England_3` (candidate prompt 3)
...
Prepared candidate-generation jobs:
- `A23_Appalachian_English_1` (candidate prompt 1)
- `A23_Appalachian_English_2` (candidate prompt 2)
...
```text
The author mood in the memoir sound gratefun and very happy. This @CAPS2 that he was greatful because Cuba music and he sound like love to write about his @CAPS1 life. One example is in the article he was greatful of his parent's for what they did. Because his parent's work financially to get where they are, This also @CAPS2 that he was happy of meeting his neigh bor hood. One example is because he said They where all family To Them. Another example was he felt warm because of that. He love what his parent's did.
```
...
```text
Dear local newspaper, I think that computers have a good effect on people. They are good because you can learn things educational. You can hear the latest stories on everything, and you can keep your information down for yourself. Computers are a good thing to have because you can learn information. @CAPS1 you have a question or don't know what something means, you can find out on the internet. These are some internet sources that are @NUM1 to answer questions. @CAPS1 we didnt have computers, then @CAPS1 you have a question, then you would have to go find a book to read in and that takes much more work. Another reason why computers are a good things is because you can catch up on all of the recent stories.
```

Prepared candidate-generation jobs:
- `A25_Southern_American_English_1` (candidate prompt 1)
- `A25_Southern_American_English_2` (candidate prompt 2)
- `A25_Southern_American_English_3` (candidate prompt 3)

## Anchor A26
- Assigned dialect: Midwestern/North Central
- Score band: high
- Normalized score: 4.2

Original anchor response:

```text
Now a days we do a lot of online shopping. This is an example of how stores connect to their customers. Stores can show buyers everything they have to offer including store locations. This can help stores get more business by connecting the buyer to the shop. The computer not only connects stores and businesses but also people to people. @PERCENT1 of kids in my school own a computer. With all these computers many social networking sites are born. The most popular right now is @CAPS1. Students can connect to old friends from other places and even other countries. We have a live chat on @CAPS1 or even @CAPS2. @CAPS2 is instant messging which is, well, instant. With a simple click people are connected no matter how far apart they are. Therefore, computers conect people. Computers also broadcast news.
```

Prepared candidate-generation jobs:
- `A26_Midwestern/North_Central_1` (candidate prompt 1)
- `A26_Midwestern/North_Central_2` (candidate prompt 2)
- `A26_Midwestern/North_Central_3` (candidate prompt 3)

## Anchor A27
- Assigned dialect: Northeastern/New England
- Score band: high
- Normalized score: 3.53
...
Prepared candidate-generation jobs:
- `A27_Northeastern/New_England_1` (candidate prompt 1)
- `A27_Northeastern/New_England_2` (candidate prompt 2)
- `A27_Northeastern/New_England_3` (candidate prompt 3)

## Anchor A28
- Assigned dialect: Western American English
- Score band: high
- Normalized score: 3.67

Original anchor response:

```text
I remember the first day being so uncomfortable and stiff. I could tell he didn't like me, he only chuckled when I would crack a joke here an there. As time went on though, I must have grew on him, because a few days later he was laughing at practically every joke I made. Those jokes had eventually led up to a friendship that would last a lifetime. Which really started when his birthday had come up in late @DATE2. He was having a small overnight birthday party which included me, his family, and his good friend @CAPS1. @CAPS1 couldn't stay overnight, so it was just me and @PERSON1. I didn't get much sleep at all that night, but that was fine with me because why i hadn't was a good enough reason not to.
```

Prepared candidate-generation jobs:
- `A28_Western_American_English_1` (candidate prompt 1)
- `A28_Western_American_English_2` (candidate prompt 2)
- `A28_Western_American_English_3` (candidate prompt 3)
...
Prepared candidate-generation jobs:
- `A29_Appalachian_English_1` (candidate prompt 1)
- `A29_Appalachian_English_2` (candidate prompt 2)
...
```text
I was going to die and the birds would pick me clean. Because the setting was a hot, deserted, desert it had a very negative effect on the cyclist. If he hadnt been running out of water I dont think that the effect of the setting would have been as bad. But because he did run out of water it made the effects much worse.
```

Prepared candidate-generation jobs:
- `A31_Southern_American_English_1` (candidate prompt 1)
- `A31_Southern_American_English_2` (candidate prompt 2)
- `A31_Southern_American_English_3` (candidate prompt 3)

## Anchor A32
- Assigned dialect: Midwestern/North Central
- Score band: high
- Normalized score: 4.07

Original anchor response:

```text
Now, I think that patience is paying off, because I finally get to visit this year. My only difficult has been that I dont get to see everyone. But not for long. I see all my friends here all the time and now Ill get to see my older friends too. Yipee for me! I cant wait! For years of waiting has provided me with an opportunity !
```

Prepared candidate-generation jobs:
- `A32_Midwestern/North_Central_1` (candidate prompt 1)
- `A32_Midwestern/North_Central_2` (candidate prompt 2)
- `A32_Midwestern/North_Central_3` (candidate prompt 3)
...
```text
Teens also find it easier to bully other children via the internet or social networks. @NUM1 out of @NUM2 students at @ORGANIZATION2 middle @ORGANIZATION2 confess to being the target of malicious bullying online. @NUM3 out of @NUM2 confess to be bullied, and they definitely don't want to be bullied on facebook or myspace where everything is out on your profile for your peers to see. Teens should have limited time on the computer, so they don't do anything they will regret in their future. Therefore, adults and teens should be aware that using a computer is fine, but they shouldn't over use the luxury of a way to find information quickly or contact a friend in a foreign country. This generation needs to be reminded that their whole life shouldn't be spent on the computer.
```

Prepared candidate-generation jobs:
- `A34_Western_American_English_1` (candidate prompt 1)
- `A34_Western_American_English_2` (candidate prompt 2)
- `A34_Western_American_English_3` (candidate prompt 3)
...
Prepared candidate-generation jobs:
- `A35_Appalachian_English_1` (candidate prompt 1)
- `A35_Appalachian_English_2` (candidate prompt 2)
...
```text
Dear newspaper editor, With all due respect to anyone that thinks the computer doesn't benefit society, I strongly disagree. Yes, there are many people that neglect other activities to be on the comuter, and yes, the computer is an invention that a lot of people depend on, but the computer is also an invention that we can benefit from in many positive ways. For example, @CAPS1' @PERSON1, a hip-hop artist with millions of fans, wasn't able to finish high school or go to colledge because of his career. He decided to get a colledge degree, so he started to attend a colledge. He had difficulty being in colledge, however, because he was constantly being harrassed by his fans, so he started going to colledge online. That way, he was able to focus on his studies and get his degree without the harrassment.
```

Prepared candidate-generation jobs:
- `A40_Western_American_English_1` (candidate prompt 1)
- `A40_Western_American_English_2` (candidate prompt 2)
- `A40_Western_American_English_3` (candidate prompt 3)
